    ...
    <div className="min-h-screen bg-[#0A0A0A] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-[#111111] border border-white/[0.06] rounded-2xl p-8">
          ...
          <p className="text-white/40 text-sm mb-8">Log in to continue your journey</p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="flex justify-end">
              <Link href="/auth/forgot-password" className="text-sm text-[#00C853] hover:text-[#00A846]">
                Forgot password?
              </Link>
            </div>
        ...
        <p className="text-center text-sm text-white/40 mt-6">
          New to Rydo?{' '}
          <Link href="/auth/register" className="text-[#00C853] hover:text-[#00A846]">Create an account</Link>
        </p>
      </div>
    </div>
  );
